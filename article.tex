...
%$
%\mathbb{P}_{\pbmotif,\min,\max}^{\ptext}(i,j)= 
%\begin{cases}
%true & \text{If $\pbmotif[i:]$ is a motif of $\ptext[j:]$ with every element in $[\min,\max]$} \\
%false & otherwise
%\end{cases}
%$
...
$\PM{\pbmotif}{\ptext}{\min}{\max}{n_\pmotif}{j}= \left\{ 
		\begin{array}{l l}
...
\textbf{STEP :} \\		
$\PM{\pbmotif}{\ptext}{\min}{\max}{i}{j}= \\ \left\{ 
		\begin{array}{l l}
