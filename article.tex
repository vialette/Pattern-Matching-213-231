...
\end{proposition}
			...
			$\mathbb{P}_{\pbmotif,\min,\max}^{\ptext}(i,j)= \\ \left\{ 
					\begin{array}{l l}
						...
						\bigcup_{j<k}\mathbb{P}_{\pbmotif,\ptext[j],\max}^{\ptext}(i+1,k) 
						...
						\bigcup_{j<k}\mathbb{P}_{\pbmotif,\min,\ptext[j]}^{\ptext}(i+1,k) 
							& \text{if $\stripe{\pmotif}{i}=\dstep$}\\
							& \text{and $i \notin \x$ and $i \notin \y$  }\\
							& \text{and $\min<\ptext[j]<\max$} \\		
						&\\
							
						\mathbb{P}_{\pbmotif,\ptext[j],\max}^{\ptext}(i+1,j+1) 
							& \text{if $\stripe{\pmotif}{i}=\ustep$}\\
							& \text{and $i \in \x$ and $i \notin \y$}\\
							& \text{and $\min<\ptext[j]<\max$} \\
						&\\
							
						\mathbb{P}_{\pbmotif,\min,\ptext[j]}^{\ptext}(i+1,j+1) 
							& \text{if $\stripe{\pmotif}{i}=\dstep$}\\
							& \text{and $i \in \x$ and $i \notin \y$ }\\
							& \text{and $\min<\ptext[j]<\max$} \\
						...
						\mathbb{P}_{\pbmotif,\ptext[j],\max}^{\ptext}(i+1,\ptext^{-1}[\ptext[j]+1]) 
							&\text{if $\stripe{\pmotif}{i}=\ustep$}\\
							&\text{and $i \notin \x$ and $i \in \y$}\\
							& \text{and $\min<\ptext[j]<\max$} \\
						...
						\mathbb{P}_{\pbmotif,\min,\ptext[j]}^{\ptext}(i+1,\ptext^{-1}[\ptext[j]-1]) 
							&\text{if $\stripe{\pmotif}{i}=\dstep$}\\
							&\text{and $i \notin \x$ and $i \in \y$ }\\	
							& \text{and $\min<\ptext[j]<\max$} \\
							&\text{and $\ptext^{-1}[\ptext[j]-1]>j$}\\
